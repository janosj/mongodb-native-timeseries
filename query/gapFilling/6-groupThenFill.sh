...
echo "Check 'resultsWithGaps' collection for output."
echo "The infrequent_reading problem has been addressed, using the last"
echo "known value, even from a previous time window."
echo "Gaps may still exist, however, when a sensor went offline and there "
echo "are therefore no documents within an individual time window."
