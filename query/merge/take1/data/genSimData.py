...
for x in range(numReadings):
  ...
  sensorReadingDoc['soc'] = float(random.randrange(0, 100))/100
  sensorReadingDoc['dissipation'] = float(random.randrange(0, 100))/100
  sensorReadingDoc['vBatt'] = float(random.randrange(0, 100))/100
  sensorReadingDoc['iBatt'] = float(random.randrange(0, 100))/100
  sensorReadingDoc['solarViewFactor'] = float(random.randrange(0, 100))/100
